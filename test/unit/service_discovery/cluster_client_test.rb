...
module ServiceDiscovery
  class ClusterClientTest < ActiveSupport::TestCase
    ...
    test 'project with discoverables' do
      ...
      cluster.expects(:get_services).with(namespace: 'project-1', label_selector: 'discovery.3scale.net/discoverable=true').returns([
        cluster_service(metadata: { name: 'non-discoverable-api-1', uid: '220151f0-1918-4eca-808a-d4d07cea4b16', namespace: 'project-1' } )
      ])

      cluster.expects(:get_services).with(namespace: 'project-2', label_selector: 'discovery.3scale.net/discoverable=true').returns([
